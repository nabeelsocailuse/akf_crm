...
class Lead(SellingController, CRMNote):
	...
	if TYPE_CHECKING:
		...
		currently_avalling: DF.Data | None
		...
		gender: DF.Link | None
		high_school_intermediate_certificate_document: DF.Data | None
		high_school_or_bachelor_gpa: DF.Data | None
		identity_card: DF.Data | None
		image: DF.AttachImage | None
		industry: DF.Link | None
		interested_in: DF.Data | None
		interested_programs: DF.Data | None
		...
		previous_degree_details: DF.Data | None
		program_interested_in: DF.Data | None
